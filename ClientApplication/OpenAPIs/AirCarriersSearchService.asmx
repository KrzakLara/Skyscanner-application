...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/AirCarriersSearchService.asmx?disco" />
    ...
    <title>
	AirCarriersSearchService Web Service
</title></head>
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">AirCarriersSearchService</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="AirCarriersSearchService.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="AirCarriersSearchService.asmx?op=SearchCarriers">SearchCarriers</a>
